function visualize_demod(fs, transmit_time, Nq, frame_len, rx_stream, H_est, image_size, bits_per_pixel, color_map, original_img, high_gain_idx)
    ...
    num_frames = length(rx_stream) / bits_per_frame;

    refresh_period = transmit_time / num_frames;
    ...
    for i=1:num_frames
        ...
        subplot(2,2,1); plot(real(h)); ylim([-3,3]); xlim([0 frame_len]);
