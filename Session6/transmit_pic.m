...
% OFDM modulation
txOfdmStream = ofdm_mod(qamStream, train_block, lt, ld, frame_length, prefix_len, high_gain_idx);
...
% OFDM demodulation
[H_est, rxQamStream] = ofdm_demod(rx_stream_aligned(1:length(txOfdmStream)), train_block, lt, ld, frame_length, prefix_len, high_gain_idx);
